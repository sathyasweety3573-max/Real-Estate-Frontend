        ...
        <div className="grid lg:grid-cols-2 gap-14 lg:gap-20 items-center w-full">
          <div>
            ...
            <div className="flex flex-wrap gap-4 mt-10">
              <Link
                to="/properties"
                className="bg-gradient-to-r from-blue-600 to-purple-600 text-white px-7 py-4 rounded-2xl shadow-lg font-bold hover:scale-105 transition flex items-center gap-2"
              >
                <Building2 size={20} />
                Explore Properties
                <ArrowRight size={20} />
              ...
              <Link
                to="/about"
                className="bg-black text-white px-7 py-4 rounded-2xl shadow-lg font-bold hover:scale-105 transition flex items-center gap-2"
              >
                <Users size={20} />
                About Us
              </Link>
      ...
      <section className="max-w-7xl mx-auto px-6 py-16">
        <div className="text-center">
          ...
          <p className="text-gray-600 mt-5 max-w-2xl mx-auto leading-8">
            A modern real-estate experience with trusted listings, easy booking,
