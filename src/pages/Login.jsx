        ...
        <div className="relative z-10 max-w-6xl w-full grid lg:grid-cols-2 gap-12 items-center">
          ...
          >
            ...
            <p className="mt-6 text-lg text-gray-600 leading-8 max-w-lg">
              Login to explore luxury villas, modern apartments,
              premium properties, and secure booking options.
            </p>

            <div className="mt-8 bg-white/80 border border-blue-100 rounded-3xl p-5 shadow-xl max-w-md">
              <h3 className="font-extrabold text-gray-800 mb-3">
                Demo Login Details
              </h3>

              <p className="text-sm text-gray-600">
                Admin and user demo credentials are available for project review.
              </p>
              ...
              <div className="mt-4 space-y-3 text-sm">
                ...
                <div className="bg-purple-50 rounded-2xl p-4">
                  <p className="font-bold text-purple-700">User</p>
          ...
          >
            ...
            {/* DEMO CREDENTIALS */}
            <div className="mt-6 bg-gradient-to-r from-blue-50 to-purple-50 border border-blue-100 rounded-3xl p-4">
              <h3 className="text-center font-extrabold text-gray-800 mb-4">
                Demo Credentials
              </h3>
              ...
              <div className="grid grid-cols-2 gap-3">
                <button
                  ...
                  className="rounded-2xl bg-white border hover:border-blue-500 shadow-sm p-3 transition text-left"
                >
                ...
                <button
                  ...
                  className="rounded-2xl bg-white border hover:border-purple-500 shadow-sm p-3 transition text-left"
                >
